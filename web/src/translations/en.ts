...
export const en = {
    ...
    'page.body.landing.marketInfo.title.text1': 'Welcome to PolarDaxNetwork.',
    ...
    'page.body.landing.register.item.text': 'PolarDaxNetwork offers an intuitive interface with real time orderbooks, charting tools, trade history, and a simple order process so you can trade from day one.',
    'page.body.landing.register.item.button': 'register',

    'page.body.landing.features.title': 'PolarDaxNetwork platform features',
    ...
    'page.body.landing.features.features.item1.text': 'PolarDaxNetwork offers the most liquid order book in the world, allowing users to easily exchange Polar, Ethereum, Dogecoin,and many other digital assets with minimal slippage.',
    'page.body.landing.features.features.item2.text': 'PolarDaxNetwork offers a suite of order types to give traders the tools they need for every scenario. Discover more about our most advanced Algorithmic orders types.',
    ...
    'page.body.landing.tradeOnTheGo.item.text3': 'All the power of PolarDaxNetwork cryptocurrency exchange, in the palm of your hand.',
    ...
    'page.body.landing.footer.rights': 'PolarDaxNetwork © All rights reserved.',
